...
const QRGenerator = () => {
    ...
    return (
        <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="max-w-4xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-700/50"
        >
                ...
                <div className="lg:col-span-2 space-y-4">
                    <div className="flex border-b dark:border-gray-700">
                        <button
                            ...
                            className={`px-4 py-2 font-medium ${activeTab === 'content' ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400' : 'text-gray-500 dark:text-gray-400'}`}
                        >
                            Content
                        </button>
                        <button
                            onClick={() => setActiveTab('design')}
                            className={`px-4 py-2 font-medium ${activeTab === 'design' ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400' : 'text-gray-500 dark:text-gray-400'}`}
                        >
                            Design
                        </button>
                        <button
                            onClick={() => setActiveTab('logo')}
                            className={`px-4 py-2 font-medium ${activeTab === 'logo' ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400' : 'text-gray-500 dark:text-gray-400'}`}
                        >
                            Logo
                        </button>
                    </div>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full p-3 border dark:border-gray-700 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                        />
                    ...
                    <div className="pt-4">
                        <button
                            ...
                            className="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white py-3 rounded-lg shadow-md transition-all flex items-center justify-center"
                        >
                            {isGenerating ? (
                                <>
                ...
                <div className="lg:col-span-1">
                    <div className="sticky top-6">
                        <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-xl shadow-inner">
                            <h3 className="text-lg font-medium text-gray-800 dark:text-white mb-4">QR Code Preview</h3>
